                        ...
                        title: 'Búsqueda por Subcuenca',
						 tools : [{
							...
							handler : function(event, toolEl, panel) {
								 ...
								 document.getElementById("busqueda_subcuenca").src='buscasubcuenca.php?ii='+Math.random();
								
								 mascara_x.show();
								 
									document.getElementById('busqueda_subcuenca').onload= function() {
										mascara_x.hide();
									};
								}
						}],
                        html:'<iframe name="busqueda_subcuenca" id="busqueda_subcuenca" width=232 height=50 frameborder=0 src="buscasubcuenca.php"></iframe>' },
                        {
                        xtype: 'panel',			
                        title: 'Búsqueda por Tramo',
                        html:'<iframe id="busqueda_tramo" id="busqueda_tramo" width=232 frameborder=0 height=150 src="buscatramos.php"></iframe>' },
						   {
                        xtype: 'panel',			
						...
						items: [
								{
									...
									collapsed:true,
									cls:'sub_panel',
									html: '<p style="font-family: Verdana; font-size: 10px;margin-left:7px"><a href="#" onclick="asi2(\'g_i\')">Gestión Informes</a><br></p>'
								},
								{
									collapsible: true,
									collapsed:true,
									cls:'sub_panel',
									title: 'Mantenedores',
									html: '<p style="font-family: Verdana; font-size: 10px;margin-left:7px"><a href="#" onclick="asi2(\'ldp\')">Línea Distribución Primaria</a><br><a href="#" onclick="asi2(\'cg\')">Concesión Geo</a><br><a href="#" onclick="asi2(\'sg\')">Servicio Geo</a><br><a href="#" onclick="asi2(\'traz\')">Trazado</a><br><a href="#" onclick="asi2(\'tra\')">Tramo</a><br><a href="#" onclick="asi2(\'tra_geo\')">Tramo Geo</a><br><a href="#" onclick="asi2(\'ot\')">Operación Trazado</a><br><a href="#" onclick="asi2(\'pro\')">Proyecto</a><br><a href="#" onclick="asi2(\'val\')">Válvula</a><br><a href="#" onclick="asi2(\'emr\')">Estación Medición Regulación</a><br><a href="#" onclick="asi2(\'hi\')">Hito</a><br><a href="#" onclick="asi2(\'cru\')">Cruce</a><br><a href="#" onclick="asi2(\'tp\')">Tipo Servicio</a><br><a href="#" onclick="asi2(\'zt\')">Zona Tarifaria</a><br><a href="#" onclick="asi2(\'gas_c\')">Gas Cargado</a><br><a href="#" onclick="asi2(\'gas_r\')">Gas Recibido</a><br><a href="#" onclick="asi2(\'gas_p\')">Gas Producido</a><br><a href="#" onclick="asi2(\'gas_e\')">Gas Entregado</a><br><a href="#" onclick="asi2(\'num_c\')">Número Cliente</a><br><a href="#" onclick="asi2(\'con_p\')">Consumo Propio</a><br><a href="#" onclick="asi2(\'ccg\')">Contrato Compra Gas</a><br></p>'
