...
function asi2(id) {
    ...
    switch (id) {
        case 'emergencias_':
            tab.add({
                title: 'Módulo Emergencias',
                iconCls: 'reportes',
                html: '<iframe src="../modulos/emergencias/app" width="100%" height="100%" scrolling="auto" align="left" style="border:none"></iframe>',
                closable: true
            }).show();
            break;
        case 'proyecto2':
            tab.add({
                title: 'Proyectos Urbanización',
                iconCls: 'reportes',
                html: '<iframe src="../modulos/otros/proyectos/" width="100%" height="100%" scrolling="auto" align="left" style="border:none"></iframe>',
                closable: true
            }).show();
            break;
        case 'g_i':
        ...
        case 'mov':
            ...
            dato.show();
            mascara_x = new Ext.LoadMask(dato.el, {
                msg: "Cargando mapa movil"
            });
            mascara_x.show();
        ...
        case 'mf':
            var dato = tab.add({
                ...
                iconCls: 'reportes',
                id: 'ventana_fugas',
                html: '<iframe id="frame_fugas" src="../../test/osm2/index_escritorio_movil.php?tablet=66&username=' + usuario + '" width="100%" height="100%" scrolling="no" align="left" style="border:none" frameBorder="0"></iframe>',
                closable: true
            });
            dato.show();
            mascara_x = new Ext.LoadMask(dato.el, {
            ...
            mascara_x.show();
            document.getElementById('frame_fugas').onload = function() {
                mascara_x.hide();
            };
            break;
    }
...

{
    ...
    items: [{
            ...
            height: 550,
            collapsible: true,
            title: "<img border='0' src='logo.png' style='width: 50%; margin-right: 10%; margin-left:20%; margin-bottom:-4px; margin-top:1px;' />",
            cls: 'tit_panel',
            border: false,
            items: [{
                ...
                items: [{
                    ...
                    tools: [{
                        ...
                        handler: function(event, toolEl, panel) {
                            mascara_x = new Ext.LoadMask(panel.el, {
                    ...
                    tools: [{
                        ...
                        handler: function(event, toolEl, panel) {
                            ...
                            document.getElementById("busqueda_cuartel").src = 'busca_elemento_apa.php?ii=' + Math.random();
                            mascara_x.show();
                            document.getElementById('busqueda_cuartel').onload = function() {
                                mascara_x.hide();
                            };
                    ...
                    html: '<iframe name="busqueda_cuartel" id="busqueda_cuartel" width=232 height=150 frameborder=0 src="busca_elemento_apa.php"></iframe>'
                }, ]
            }, {
                xtype: 'hr_htmlpanel', //modulos apa
                id: 'hr-info-west2s',
                border: true,
                hidden:eval(apa),
                html: Heron.options.info.html,
                ...
                items: [{
                    ...
                    collapsed: true,
                    collapsible: true,
                    html: '<p style="font-family: Verdana; font-size: 11px;margin-left:5px"><img src="images.png" alt="vineta" style="margin-bottom: -1px; margin-right: 4px;" width="6%"><a href="#" style="text-decoration:none;margin-bottom: -4px; " onclick="asi2(\'emergencias_\')">Emergencias</a><br></p>'
                } ]
            }, {
                xtype: 'panel',
                collapsed: true,
            ...
            title: 'Dashboard',
            iconCls: 'dashboard',
            html: '<iframe id="iframe_google" src="https://datastudio.google.com/embed/reporting/1qAJfK67ENwUzwTdJQwaW64NBe4ZgStSX/page/j2bL" width="100%" height="100%" scrolling="auto" align="left" style="border:none;"></iframe>',
            }//,
           // {
           // title: 'Dashboard',
           // iconCls: 'dashboard',
           // html: '<iframe src="../../externo_gestorAST/dashboard/" width="100%" height="100%" scrolling="auto" align="left" style="border:none"></iframe>',
        //}
        ]
        }, new Ext.Panel({ // raw
            region: 'south',
            height: 25,
            html: "<span style='font-weight: bold; padding-top: 3px;' id='menu_usuario'><input style='padding: 3px 4px 3px 4px; margin-right: 1%; float: right; background-color: #1248A2; color: #FBFCFD; font-weight: bold; border:none; border-radius: 10%;' type='button' name='Salir' id='Salir' value='Salir' onclick='confrm_ext()'/><label style='padding:4px 0 0 0;float: right; padding-right: 2%;'>Bienvenido : " + name_usu + "</label></span>",
            style: {
