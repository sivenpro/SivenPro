...

                {
				...
				
				  {
					...
					
					{
						...
						collapsible: true,	
						collapsed:true,						
						html: '<p style="font-family: Verdana; font-size: 11px;margin-left:5px"><img src="images.png" alt="vineta" style="margin-bottom: -1px; margin-right: 4px;" width="-6%"><a href="#" style="text-decoration:none;margin-bottom: -4px; " onclick="asi2(\'mc\')">Corte</a><br></p>'					
					},
