<?php
        ...
        case 'registrar':
            if ($nombre_perfil!= "") {
                ...
                if ( $existe > 0) {
                    ...
                    registrar($nombre_perfil, $admin_click, $bode_click, $cont_click, $conn);
                }
            }else{
            ...
            break;
        case 'modificar':
            modificar($id, $nombre_perfil, $admin_click, $bode_click, $cont_click, $conn);
            break;
        case 'eliminar':
            eliminar($id, $conn);
            break;
    ...
    function registrar($nombre_perfil, $admin_click, $bode_click, $cont_click, $conn){
        $query = "INSERT INTO id18070131_sivenpro.perfiles(nombre, administrador, bodeguero, contador)
                  VALUES('$nombre_perfil', '$admin_click', '$bode_click', '$cont_click')";
    ...
    function modificar($id, $nombre_perfil, $admin_click, $bode_click, $cont_click, $conn){
        $query="UPDATE id18070131_sivenpro.perfiles SET nombre= '$nombre_perfil',
    ...
    function eliminar($id, $conn){
        $query = "UPDATE id18070131_sivenpro.perfiles SET estado='Eliminado' WHERE id_perfil='$id'";
        $resultado = mysqli_query($conn, $query);
        verificar_resultado( $resultado );
        cerrar( $conn );
    }
    ...
    function existe_perfil($nombre_perfil, $conn){
        $query = "SELECT nombre FROM id18070131_sivenpro.perfiles WHERE nombre='$nombre_perfil'";
        $resultado = mysqli_query($conn, $query);
