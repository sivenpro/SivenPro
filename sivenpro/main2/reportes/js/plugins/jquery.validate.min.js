...
!function (a) {
    ...
    a.extend(a.fn, {
        validate: function (b) {
            if (!this.length)
                return void (b && b.debug && window.console && console.warn("Nada seleccionado, no puedo validar, retorno nada."));
        ...
        a.extend(a.validator, {
            ...
            messages: {
                ...
                url: "Ingresa un formato correcto de URL.",
                date: "Formato de fecha incorrecto",
                dateISO: "Formato de fecha ( ISO ) incorrecto.",
                number: "Ingresa un número válido",
                digits: "Ingresa solo dígitos",
                creditcard: "Ingresa una tarjeta de credito válida",
                equalTo: "Ingresa el mismo valor anterior",
                maxlength: a.validator.format("No puedes ingresar más de {0} carácteres."),
                minlength: a.validator.format("Debes ingresar al menos {0} carácteres."),
                rangelength: a.validator.format("Solo se permiten entre {0} y {1} carácteres"),
                range: a.validator.format("Ingresa solo valores entre {0} y {1}."),
                max: a.validator.format("Ingresa un valor menor o igual a {0}."),
                min: a.validator.format("Ingresa un numero mayor o igual a {0}.")
            },
            autoCreateRanges: !1,
            prototype: {
                init: function () {
