    ...
    $.post("lee_login.php", {
        ...
        switch (result) {
            case 'Log Error':
                $.notify({
                    icon: "error",
                    message: "<strong>Usuario y/o contraseña incorrecta</strong> vuelva a intentar"
                }, {
                    type: "danger",
                    timer: 3,
                    placement: {
                ...
                break;
            case 'Login sin acceso':
                $.notify({
                    icon: "error",
                    message: "<strong>Acceso Denegado</strong> no tienes permiso para acceder, contacta al Administrador"
                }, {
                    type: "danger",
                    timer: 3,
                    placement: {
            ...
            case 'Log Ok':
                location.reload();
                //$.wait( function(){ $("#a-mod_pagocollapsed").trigger("click"); }, 5);
                //$('#ods_proyectos').trigger('click');
                break;
        }
    });
