...
function generaPDFParametros($id_registro, $nombre_archivo, $html_body_pdf){
     ...
     $absolute_logo = dirname(__FILE__) . "/gassur.png";
     ...
     <body>
         <div id="cabecera">
            <img style="width:25%; margin-bottom:20px;" src="' . $absolute_logo . '" />
            <p>Fecha generado: ' . $hora_generado . '</p>
            <h3>Registro N&deg;: ' . $id_registro . '</h3>';
    ...
    //  }
     ...
     $html2pdf = new Html2Pdf('P', 'A4', 'es', 'true', 'UTF-8', array(5, 15, 5, 20)); //modificar el codigo para cuando el alto de la pagina no alcance para toda la informacion
